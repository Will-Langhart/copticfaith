# CopticFaith — Project Guidelines

## Project Overview
CopticFaith is a React + Vite + Tailwind web application serving as a theological reference site for Coptic Orthodox Christianity. It includes pages on the Seven Holy Mysteries, Church Fathers, Church History, a Popular Patristics Series book catalog, glossary, scripture index, FAQ, and more.

**Stack:** React 18, Vite, React Router v6, react-i18next, Tailwind (via custom CSS tokens), deployed on Vercel.
